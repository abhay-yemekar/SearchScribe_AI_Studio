"""Alembic migration environment wired to SearchScribe models and settings."""
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            target_metadata=target_metadata,
            compare_type=True,
            # SQLite cannot ALTER most constructs in place; batch mode
            # rebuilds tables, which is a no-op for fresh databases.
